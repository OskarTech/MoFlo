...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontFamily: 'Poppins_700Bold', marginBottom: 8, textAlign: 'center' },
  subtitle: { fontSize: 14, fontFamily: 'Poppins_400Regular', textAlign: 'center', lineHeight: 22 },
  input: { marginBottom: 16 },
  button: { borderRadius: 12 },
  buttonContent: { height: 52 },
  successCard: { borderRadius: 16, padding: 24, alignItems: 'center', borderWidth: 0.5 },
  successText: { fontSize: 18, fontFamily: 'Poppins_600SemiBold', marginTop: 16, marginBottom: 8, textAlign: 'center' },
  successSubtext: { fontSize: 14, fontFamily: 'Poppins_400Regular', textAlign: 'center', lineHeight: 22 },
});
