...
const AnnualScreen = () => {
  ...
  const monthSummary = useMemo(() => ({
    ...
    expense: monthMovements
      .filter(m => m.type === 'expense')
      .reduce((s, m) => s + m.amount, 0),
    saving: monthMovements
      ...
      >
        ...
        <View style={styles.filtersRow}>
          ...
          <View style={styles.selectorRow}>
            <TouchableOpacity
              onPress={() => {
                setSelectedAnnualYear(selectedAnnualYear - 1);
          ...
          <>
            ...
            <View style={[styles.chartCard, {
              ...
              <BarChart
                ...
                noOfSections={4}
                maxValue={
                  Math.max(...annualData.map((m) =>
                    Math.max(m.income, m.expense))) * 1.2 || 100
                }
