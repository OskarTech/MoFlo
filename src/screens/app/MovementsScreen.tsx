...
const MovementRow = ({
  ...
  const handleDelete = () => {
    Alert.alert(
      ...
      `${movement.description} — ${movement.amount.toFixed(2)} ${currencySymbol}`,
      [
        ...
        <View style={styles.movementTitleRow}>
          ...
          {movement.isRecurring && (
            <View style={styles.recurringBadge}>
              ...
              <Text style={styles.recurringBadgeText}>{t('movementsList.recurring')}</Text>
            </View>
          )}
        </View>
        <Text style={[styles.movementMeta, { color: dc.textSecondary }]}>
...
const MovementsScreen = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: dc.background }]}>
      <AppHeader title={t('header.movements')} />
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={[styles.emptySubtext, { color: dc.textSecondary }]}>
              {t('movementsList.noMovementsSubtitle')}
            </Text>
          </View>
        }
      />
